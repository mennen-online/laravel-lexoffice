<template>
  <div class="min-h-screen bg-slate-50">
    <div class="p-6">
      <div id="table">
        <div
          class="mb-4 flex flex-row items-baseline justify-between px-2 text-slate-900"
        >
          <div>
          ...
          <div class="row flex flex">
            ...
            <div class="ml-4 flex flex-row gap-2">
              <svg
                class="relative h-6 w-6 cursor-pointer rounded-sm outline outline-1 outline-slate-500 transition ease-out hover:scale-105"
                fill="none"
                stroke="currentColor"
                stroke-width="1"
                viewBox="0 0 24 24"
        ...
        <div class="mb-8 overflow-hidden rounded-xl bg-slate-50 shadow">
          <table
            v-if="this.entries.length"
            class="h-full w-full text-left align-baseline"
          >
            <th class="bg-blue-300 px-4 py-1 text-lg font-semibold">Vorname</th>
            <th class="bg-blue-300 px-4 py-1 text-lg font-semibold">
              Nachname
            </th>
            <th class="bg-blue-300 px-4 py-1 text-lg font-semibold">
              Kundennummer
